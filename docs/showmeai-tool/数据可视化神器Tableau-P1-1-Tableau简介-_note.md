# 数据可视化神器Tableau！P1：Tableau简介 📊

![](img/3b657b1be778fedd8766bd485966796f_1.png)

在本节课中，我们将要学习什么是Tableau，了解它的起源、核心功能以及它在数据可视化领域的地位。通过本节内容，你将明白为何Tableau被誉为现代商业智能和数据可视化的强大工具。
...
本节课中我们一起学习了Tableau的基本概念。我们了解到Tableau是一个源于斯坦福大学的强大视觉分析平台，它通过直观的拖放界面连接多种数据源，将复杂数据转化为易于理解的交互式可视化图表。其核心优势在于无需编程技能、易于上手、性能强大且能适应多种设备，因此被广泛认为是现代商业智能领域的领导者工具。